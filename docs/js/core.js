        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background: var(--glass); backdrop-filter: blur(12px) saturate(1.1); border: 1px solid rgba(255,255,255,0.2);">
                ...
                <div class="modal-body">
                    ...
                    <hr class="my-4">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Password Management</label>
                        <div class="alert alert-info mb-0 d-flex align-items-start">
                            <i class="bi bi-shield-lock-fill me-2 mt-1"></i>
                            <div>
                                Admin credentials are managed centrally via GitHub Secrets. <strong>Please contact IT Support</strong> to request a password update.
                            </div>
                        </div>
                    </div>
                </div>
...
function showChangePasswordModal() {
    careMarshallAlert('Admin passwords are managed centrally via IT through GitHub Secrets. Please contact IT support to request an update.', 'info');
}

function savePasswordChange() {
    careMarshallAlert('Password changes cannot be performed here. Please contact IT support to request an update.', 'info');
}
